...
export function parseDocumentProcessingJobPayload(payload: unknown): DocumentProcessingJobPayload { return documentProcessingJobPayloadSchema.parse(payload); }
